          ...
          <tr>
            <td style="padding:36px 40px 32px;">
              ...
              <div style="background:#f8fafc;border:1.5px solid #e2e8f0;border-radius:14px;padding:28px 24px;text-align:center;margin-bottom:28px;">
                <p style="margin:0 0 16px;font-size:11px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:2px;">Your one-time code</p>

                <div style="display:inline-block;background:#ffffff;border:2px solid #16a34a;border-radius:12px;padding:14px 36px;">
                  <span style="font-size:36px;font-weight:700;color:#0f172a;font-family:'Courier New',monospace;letter-spacing:10px;">${otp}</span>
                </div>
